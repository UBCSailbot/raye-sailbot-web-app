...
var winch_motor_html = document.getElementById("Winch Motor").getElementsByTagName("TD");
var wind_html = document.getElementById("Wind").getElementsByTagName("TD");
var gps_html = document.getElementById("GPS").getElementsByTagName("TD");
var boom_angle_html = document.getElementById("Boom Angle").getElementsByTagName("TD");
var bms_html = document.getElementById("BMS").getElementsByTagName("TD");
var rudder_motor_html = document.getElementById("Rudder Motor").getElementsByTagName("TD");
var accelerometer_html = document.getElementById("Rudder Motor").getElementsByTagName("TD");
